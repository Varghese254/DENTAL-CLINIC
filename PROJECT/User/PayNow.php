                ...
                <div class="form">
                    <form method="post">
                        ...
                        <div class="card space icon-relative">
                            ...
                            <input type="text" class="input" placeholder="Card Number"  required  pattern="[0-9]{1}[0-9]{15}" onchange="checkcardno(this)"  title="16 digits are required"/>
                            <span id="cardno"></span></td>
                            <i class="far fa-credit-card"></i>
                        </div>
                        <div class="card-grp space">
                            <div class="card-item icon-relative">
                                <label class="label">Expiry date:</label>
                                <input type="month" name="expiry-data" class="input" data-mask="00 / 00" placeholder="00 / 00" min="<?php echo date("Y-m")?> required="required">
...
function emailval(elem)
{
  ...
  <script src="../Assets/JQuery/jQuery.js"></script>
    <script>
  function checkcardno(elem)
{
	var numericExpression = /^[0-9]{1}[0-9]{15}$/;
	...
	{
		document.getElementById("cardno").innerHTML = "<span style='color: red;'>16 digits required</span>";
		elem.focus();
		return false;
	}
}
