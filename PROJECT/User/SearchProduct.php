        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3">
                     ...
                     <a href="../User/HomePage.php"><i style="font-size:24px;color:black" class="fa">&#xf015;</i></a></p> 
                   ...
                   <div align="center">
  <h2><B><a href="MyCart.php".php"><i class="fa fa-shopping-cart" style="font-size:48px;color:black"></i></a></B></h2></div>
