          ...
          <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                       ...
                       <a href="MyBooking.php" class="dropdown-item">My Booking</a>
                         <a href="ViewPrescription.php" class="dropdown-item">Prescriptions</a>
                        <a href="ChangePassword.php" class="dropdown-item">Change Password</a>
                                          </div>
                                         
                </div>
             
                <a href="MyCart.php" class="nav-item nav-link"><i style="font-size:24px" class="fa">&#xf07a;</i></a>
                <div class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu m-0">
                      ...
                      <a href="ActiveDentists.php" class="dropdown-item">Book An Appointment</a>
                      <a href="RequestStatus.php" class="dropdown-item">Status Of My AppointmentRequest</a>
                    
                                        </div>
                                       
              </div>
                <a href="SearchProduct.php" class="nav-item nav-link"><i style="font-size:24px" class="fa">&#xf002;</i> Product</a>
    ...
    <!-- Offer Start -->
     <div class="container-fluid bg-offer my-5 py-5 wow fadeInUp" data-wow-delay="0.1s">
       ...
       <a href="../User/CODList.php" class="btn btn-dark py-3 px-5">Cash On Delivary</a>&nbsp;
                ...
                <a href="../User/PayedList.php" class="btn btn-dark py-3 px-5">Paid List</a>         
                    </div>
                </div>
            </div>
        </div>
