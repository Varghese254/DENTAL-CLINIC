...
<form id="form1" name="form1" enctype="multipart/form-data" method="post" action="">
  <table width="549" height="402" border="1" cellpadding="10" align="center">
    <tr>
      <td width="1">Name</td>
      <td width="3"><input type="text" name="txt_name" id="txt_name"  title="Name Allows Only Alphabets,Spaces and First Letter Must Be Capital Letter" pattern="^[A-Z]+[a-zA-Z ]*$" onchange="nameval(this)" autocomplete="off" /></td>
    </tr>
    <tr>
      <td>Gender</td>
      <td><p>
    ...
    <tr>
      <td>Contact</td>
      <td><input type="contact" name="txt_contact" id="txt_contact" required="required" autocomplete="off"  title="Phone number with 7-9 and remaing 9 digit with 0-9" pattern="[7-9]{1}[0-9]{9}" onchange="checknum(this)" /></td>
