            ...
            <div class="nav-item dropdown">
              <div class="dropdown-menu m-0">
                ...
                <div class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu m-0">
                  <a href="DentistType.php".php" class="dropdown-item">Add DentistType</a>
              ...
              <div class="nav-item dropdown">
                  ...
                  <a href="pie.php" class="dropdown-item">Product Sales</a>
                      ...
                      <a href="SalesFrom.php" class="dropdown-item">From-Sales-To</a>
                       ...
                       <a href="DentistRating.php" class="dropdown-item">Dentist Rating</a>  
               ...
               <div class="nav-item dropdown">
                  ...
                  <a href="PayedList.php" class="dropdown-item">Payed List Of Products</a>
                   <a href="PayedDoc.php" class="dropdown-item">Consulted Appointments</a>
                  </div>
             
          </div>
            </div>
            
            <a href="../Guest/Logout.php" class="btn btn-primary py-2 px-4 ms-3">Logout</a>
        </div>
    </nav>
    <!-- Navbar End -->
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown">ADMIN-PANEL</h5>
                ...
                <div class="col-lg-7">
                   ...
                   <a href="../Admin/District.php" class="btn btn-primary py-3 px-5 mt-4 wow zoomIn" data-wow-delay="0.6s">Add Districts</a>
                    ...
                    <a href="../Admin/ServiceList.php" class="btn btn-primary py-3 px-5 mt-4 wow zoomIn" data-wow-delay="0.6s">Add More Services</a>
                     <a href="../Admin/Orders.php" class="btn btn-primary py-3 px-5 mt-4 wow zoomIn" data-wow-delay="0.6s">Product Orders</a>
