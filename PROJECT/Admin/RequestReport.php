...
?>
<center><B><h2>Appointment Report</h2></B></center>
...
?>	
  ...
  <table  border="1" cellpadding="10" align="center">
    <tr>
      ...
      <td width="46">Patient_id</td>
      <td width="46">Name</td>
          <td width="46">Photo</td>
       <td width="59">Date</td>
       <td width="59">Diaganosis</td>
          <td width="59">Dentist</td>
    ...
    <td><?php echo $data["user_id"];?></td>
        <?php $original_date =$data['appointment_date'];
    ...
    <td><?php echo $data["user_name"];?></td>
      ...
      <td><img src="../Assets/Files/UserPhoto/<?php echo $data["user_photo"];?>"width="120" height="120"/></td>
       <td><?php echo $data["dentist_name"];?></td>
