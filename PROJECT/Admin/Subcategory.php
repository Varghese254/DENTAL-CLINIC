...
if(isset($_POST["btn_submit"]))
{
		...
		$name=$_POST["txt_name"];
		$sel="select * from tbl_subcategory where subcategory_name='".$name."'";
	$res=$con->query($sel);
...
<form id="form1" name="form1" method="post" action="">
  <table width="424" height="174" border="1" cellpadding="2" cellspacing="2" align="center">
   <tr>
      <td width="171">Category Name</td>
      <td width="233">
...
?>		 
    ...
    <tr>
      <td width="171">Sub Category</td>
      <td width="233"><label for="txt_name"></label>
