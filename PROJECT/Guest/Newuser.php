...
<form id="form1" name="form1" enctype="multipart/form-data" method="post" action="">
  <table width="549" height="402" border="1" cellpadding="10" >
    <tr>
      <td width="1">Name</td>
      <td width="3">
        <input type="text" name="txt_name" id="txt_name"  required="required" title="Name Allows Only Alphabets,Spaces and First Letter Must Be Capital Letter" pattern="^[A-Z]+[a-zA-Z ]*$" onchange="nameval(this)" autocomplete="off"/>
    ...
    <tr>
      <td>Contact</td>
      <td><input type="contact" name="txt_contact" id="txt_contact" required="required" autocomplete="off"  title="Phone number with 7-9 and remaing 9 digit with 0-9" pattern="[7-9]{1}[0-9]{9}" onchange="checknum(this)" />
                <span id="contact"></span></td>
    
    </tr>
    <tr>
      <td>E-mail</td>
      <td><input type="email" name="txt_mail" id="txt_mail"  required="required" autocomplete="off" onchange="emailval(this),CheckEmail(this.value)" />
    ...
    <tr>
      <td>Password</td>
      <td><input type="password" name="txt_password" id="myInput"  required="required" autocomplete="off" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"/>
    ...
    <tr>
      ...
      <td><input type="password" name="txt_cpassword" id="myInput" required="required" autocomplete="off"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"  onchange="chkpwd(this,txt_password)" />
      <span id="pass"></span></td>      
