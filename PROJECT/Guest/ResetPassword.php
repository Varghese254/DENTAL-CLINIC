...
if(isset($_POST["btnreset"]))
{
	...
	{
		$sela="select * from tbl_admin where admin_email='".$_SESSION["Aid"]."'";
		$rowa=$con->query($sela);
	
		$sell="select * from tbl_dentist where dentist_email='".$_SESSION["uid"]."'";
		$rowl=$con->query($sell);
		...
		{
			$up="update tbl_admin set admin_password='".$_POST["txtnew"]."' where admin_email='".$_SESSION["Aid"]."'";
			$con->query($up);
		}
		else if($datal=$rowl->fetch_assoc())
		{
			$up="update tbl_dentist set dentist_pass='".$_POST["txtnew"]."' where dentist_email='".$_SESSION["uid"]."'";
			$conn->query($up);
		}
